...
const ReviewCardComponent = ({ review, onDetailClick, setReviews, reviews }) => {
  ...
  // 리뷰 수정 함수
  const handleEdit = (alcoholId, reviewId) => {
      ...
      <Card.Body className='actionBtn'>
        {user && user.id === review.review.userId && (
              <div className="review-actions">
                  <FontAwesomeIcon
                      icon={faEdit}
                      onClick={() => handleEdit(review.review.alcoholId, review.review.id)}
